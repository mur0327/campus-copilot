...
<div class="guide">
  ...
  말아 주세요.
  <ul>
    <li>① 이 문서들 안에 질문의 답이 있습니까? — 있음 / 일부만 / 없음.
      <strong>내용만 봐 주세요.</strong> 문서가 옛날 것인지, 특정 학과·대학원
      전용인지는 여기서 따지지 않습니다. 예: 지난 학기 등록금 공지에 납부
      기간이 적혀 있다면, 낡았더라도 ①은 "있음"입니다.</li>
    <li>② 이 문서들을 근거로, 지금 키오스크 앞의 일반 학생에게 답해 줘도
      됩니까? — 답변 / 거절. <strong>시기와 대상은 여기서 반영해 주세요.</strong>
      옛날 공지라서, 특정 학과·대학원 전용이라서 답하면 안 된다면 ②를
      "거절"로 하고 이유에 표시해 주세요.</li>
  </ul>
  <br>
