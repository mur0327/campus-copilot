...
- [18-exp-07-answer-evaluation-protocol.md](18-exp-07-answer-evaluation-protocol.md) — EXP-07 최종 응답 판정 기준과 실행·동결 계약.
...
1. 18 — 현행 EXP-07 판정·실행 계약.
2. 17 — qrel v4 사람 감사 범위와 실행 기록.
3. 16 — qrel v4를 만들게 된 결함과 설계 승인 조건.
4. 15 — RQ·EXP-07 방향과 전체 실행 순서.
5. 05 — 지금 어디까지 왔고 무엇이 미결정인지.
6. 06 — 실험이 실제로 뭘 보여줬는지 (뒤쪽 추기까지 읽어야 최신 판정).
7. 08 — 알려진 약점과 대응 계획.
