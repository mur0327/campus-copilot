...
- procedure_steps는 짧은 행동 단계로 작성하세요.
  - 각 procedure_steps 항목은 20~35자 안팎의 명사형 구문으로 작성하세요.
  - 가능하면 "~합니다", "~하세요" 같은 종결형 문장 대신 "방문 및 작성", "상담 진행", "서류 제출"처럼 간결한 행동명으로 작성하세요.
  - 단, 공식 문서에 없는 행동을 추가하거나 순서를 바꾸지 마세요.
  - 의미가 달라질 수 있으면 억지로 줄이지 말고 원문 의미를 보존하세요.
